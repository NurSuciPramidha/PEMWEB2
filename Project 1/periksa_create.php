...
$periksa = $dbh->query('SELECT * FROM periksa');
include_once('top.php');
include_once('menu.php');
?>
<div class="container-fluid px-4">
    <h1 class="mt-4">Kunjungan Pasien</h1>
    ...
    <form action="periksa_store.php" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="berat" name="berat" type="double" class="form-control" required="required">
            </div>
        </div>
        <div class="form-group row">
            <label for="tinggi" class="col-4 col-form-label">Tinggi Badan</label>
            <div class="col-8">
                <input id="tinggi" name="tinggi" type="double" class="form-control" required="required">
            </div>
        </div>
        <div class="form-group row">
            <label for="tensi" class="col-4 col-form-label">Tensi</label>
            <div class="col-8">
                <input id="tensi" name="tensi" type="int" class="form-control" required="required">
            </div>
        </div>
        <div class="form-group row">
